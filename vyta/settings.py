"""
Django settings for vyta project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-l627pitt%@y@oh=m9_$+d3dfer=!ohw$lo)oi**%a*8o3kxjy2')
...
WSGI_APPLICATION = 'vyta.wsgi.application'
